...
int		ft_pr_hex_pr(int nb, char ccase, t_mdf *modifiers, int num_len);
int		ft_pr_hex_wdh(int nb, char ccase, t_mdf *modifiers, int num_len);
int		ft_print_hex_mod(int nb, char ccase, t_mdf *modifiers);
int		ft_pr_hex_wdh_pr(int nb, char ccase, t_mdf *modifiers, int num_len);
