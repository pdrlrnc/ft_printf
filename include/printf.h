...
int		ft_pr_hex_pr(unsigned long long nb, char ccase, t_mdf *modifiers, int num_len);
int		ft_pr_hex_wdh(unsigned long long nb, char ccase, t_mdf *modifiers, int num_len);
int		ft_print_hex_mod(unsigned long long nb, char ccase, t_mdf *modifiers);
int		ft_pr_hex_wdh_pr(unsigned long long nb, char ccase, t_mdf *modifiers, int num_len);
